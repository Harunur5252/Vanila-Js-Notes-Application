...
# Notes Application 
This project is like product catalogue or tweet project.

## Project Specifications

+ Created a simple UI(user interface).
+ Initial state have one button and search option.
+ If click on button then a new notes title input and description will appear for new write new note.
+ A user can enter a note title and description in the input filed.
+ Then these value will show on ui and save data to localStorage.
+ And user can edit , update , delete and search note items.


## Project Picture

![Note App!](/src/images/note_pic1.PNG "Note App")

![Note App!](/src/images/note_pic2.PNG "Note App")
